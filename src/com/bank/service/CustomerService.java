...
public class CustomerService extends HttpServlet  { 
	...
	//used to log errors, bugs, and information to the applications log file
	...
	public String openAccount(String newAccountDetails) throws SQLException, JSONException{
		...
		Integer zip = (Integer)custObj.get("zip");
	...
	@GET
	//	@Produces({MediaType.APPLICATION_JSON})
	public Account getAccount(@PathParam("id")long customerid) throws SQLException{
